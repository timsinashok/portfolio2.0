               ...
               >
                 ...
                 <div className="space-y-4">
                   <div className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-sm">
                     <code className="text-sm text-zinc-600 dark:text-zinc-300">ashok@systems.dev</code>
                     <button 
                       onClick={() => navigator.clipboard.writeText('ashok@systems.dev')}
